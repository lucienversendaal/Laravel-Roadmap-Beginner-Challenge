<x-main-layout>
    <x-slot name="header">
        <section class="w-full px-6 antialiased bg-white">
            <div class="mx-auto max-w-7xl">
                <!-- Main Hero Content -->
                <div
                    class="container max-w-sm py-24 mx-auto mt-px text-left sm:max-w-md sm:px-4 md:max-w-none md:text-center">
                    <h1
    ...
    <x-slot name="footer">
        ...
        <div class="mt-8 md:order-1 md:mt-0">
            <p class="text-xs leading-5 text-center text-gray-500">&copy; 2020 Your Company, Inc. All rights reserved.
            </p>
        </div>
    </x-slot>
</x-main-layout>
